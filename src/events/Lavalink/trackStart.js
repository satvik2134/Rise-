...
module.exports = async (client, player, track, payload) => {
  ...
  const thing = new MessageEmbed()
    ...
    .setTimestamp()
  const But1 = new MessageButton().setEmoji("🔉").setCustomId("vdown").setStyle("SECONDARY");
    
   const But2 = new MessageButton().setEmoji("⏹️").setCustomId("stop").setStyle("SECONDARY");
