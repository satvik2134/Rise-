...
const disabled = '<a:no:1158411070608769034>'

const enabled = '<a:cx_tick:1158669360223748106>'
        ...
        embeds: [new MessageEmbed()
          ...
          .addFields([
...

            {
              ...
              value: `**Total: ** ${channels.size}\n**Channels: **#️⃣  ${channels.filter(channel => channel.type === 'GUILD_TEXT').size} | 🔉 ${channels.filter(channel => channel.type === 'GUILD_VOICE').size}`
